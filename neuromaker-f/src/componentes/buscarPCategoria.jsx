...
class BuscarPCategoria extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentWillMount() {
    if(this.props.match.params.categoria != null){
        //Axios se encarga de hacer solicitudes de forma sencilla
      axios.post(`http://localhost:4000/producto/filtrarPCategorias/${this.props.match.params.categoria}`)
      .then((response) => {
...
export default withRouter(BuscarPCategoria);